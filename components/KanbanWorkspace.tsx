    ...
    <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        ...
        <div className="flex items-center gap-3">
          <div className="glass-pill px-3.5 sm:px-4 py-2 rounded-2xl flex items-center justify-between sm:justify-start w-full sm:w-auto gap-3">
            <div>
            ...
            <button
              ...
              className="px-3 py-1.5 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold flex items-center gap-1.5 transition-colors shadow-sm shrink-0"
            >
      ...
      <div className="flex items-center justify-between gap-3 mb-6 bg-white p-2.5 sm:p-3 rounded-2xl border border-zinc-200/80 shadow-sm overflow-hidden">
        <div className="flex items-center gap-2 overflow-x-auto no-scrollbar pb-1 sm:pb-0 w-full sm:w-auto">
          <span className="text-xs font-bold text-zinc-500 flex items-center gap-1 pl-1 shrink-0">
            <Filter className="w-3 h-3" /> Filter:
          </span>
          <button
            onClick={() => setFilterMilestone('ALL')}
            className={`px-2.5 sm:px-3 py-1 rounded-xl text-xs font-semibold whitespace-nowrap shrink-0 transition-all ${
              filterMilestone === 'ALL'
        ...
        <div className="hidden sm:block text-xs font-mono text-zinc-400 shrink-0">
